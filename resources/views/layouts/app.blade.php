...
<head>
    ...
    <title>{{ config('app.name', 'Fight Club') }}</title>
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:site" content="@Paper_Street_" />
        <meta name="twitter:creator" content="@Fenril992" />
        <meta name="twitter:title" content="Paper Street Soap Co." />
        <meta name="twitter:description" content="Camp d’entraînement de Muay Thai & MMA Nord Strasbourg.
        Gymnase Mermoz & Kwartz 2 rue Perle." />
        <meta name="twitter:image"
            content="https://pbs.twimg.com/profile_images/1632409923580461056/qBUBv6Nw_400x400.jpg" />
        <meta name="twitter:url" content="https://x.com/Paper_Street_" />
...
<body class="g-sidenav-show  bg-gray-100">
    @php
        $topSidenavArray = [ 'wallet', 'profile.edit'];
        $topSidenavTransparent = ['signin', 'signup', 'search'];
        $topSidenavRTL = ['RTL'];
    @endphp
