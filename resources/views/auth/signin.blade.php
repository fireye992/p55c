                        ...
                        <div class="col-md-5 d-flex flex-column">
                            <div class="card card-plain mt-8">
                                <div class="card-header pb-0 text-left bg-transparent text-center">
                                    <h3 class="font-weight-black text-dark display-6">Team PSSC</h3>
                                ...
                                <div class="card-body">
                                    <form role="form" class="text-start" method="POST" action="sign-in">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <a href="{{ url('auth/google') }}" class="btn btn-white btn-icon w-100 mb-3">
                                                <span class="btn-inner--icon me-1">
                        ...
                        <div class="col-md-6">
                            <div class="position-absolute w-40 top-0 end-0 h-100 d-md-block d-none">
                                <div class="oblique-image position-absolute fixed-top ms-auto h-100 z-index-0 bg-cover ms-n8"
                                    ...
                                    <div
                                        class="blur mt-12 p-4 text-center border border-white border-radius-md position-absolute fixed-bottom m-7">
                                        <h2 class="mt-3 text-dark font-weight-bold">Rejoins la communauté du Paper Street Soap Co.</h2>
                                        <h6 class="text-dark text-sm mt-5">Copyright © 2024 Fenrir</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
